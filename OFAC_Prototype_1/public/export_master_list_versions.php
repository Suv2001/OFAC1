...
$headers = ['Sl No.', 'Business Name', 'Owner', 'Address', 'Status', 'Uploaded By', 'Uploaded At'];
...
switch ($type) {
    case 'pdf':
        ...
        class CustomPDF extends FPDF_Alpha
        {
            ...
            function Header()
            {
                ...
                $this->Cell(0, 10, "Previous Versions of Registration No: " . $GLOBALS['reg_no'], 0, 1, 'C'); // Centered heading
        ...
        $fifthColWidth = 21; // Fixed width for the fifth column (Status)
        ...
        // Output the PDF
        $pdf->Output('D', 'Previous_Versions_' . $reg_no . '.pdf');
        break;
    ...
    case 'excel':
        ...
        $sheet->setTitle('Previous Versions');

        // Add title
        $sheet->setCellValue('A1', 'Previous Versions of Registration No: ' . $reg_no);
        ...
        $filename = 'Previous_Versions_' . $reg_no . '.xlsx';
    ...
    case 'csv':
        ...
        $filename = 'Previous_Versions_' . $reg_no . '.csv';
