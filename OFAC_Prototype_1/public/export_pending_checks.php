...
$headers = ['Sl No.', 'Business Name', 'Owner', 'Address', 'Reg. No', 'Uploaded By', 'Uploaded At'];
...
switch ($type) {
    case 'pdf':
        ...
        class CustomPDF extends FPDF_Alpha
        {
            ...
            function Header()
            {
                ...
                $this->Cell(0, 10, "Pending Business Detail Checks ", 0, 1, 'C'); // Centered heading
        ...
        $fifthColWidth = 21; // Fixed width for the fifth column (reg_no')
        ...
        // Output the PDF
        $pdf->Output('D', 'Pending_Business_Detail_Checks.pdf');
        break;
    ...
    case 'excel':
        ...
        $sheet->setTitle('Pending Checks');

        // Add title
        $sheet->setCellValue('A1', 'Pending Business Detail Checks');
        ...
        $filename = 'Pending_Business_Detail_Checks.xlsx';
    ...
    case 'csv':
        ...
        $filename = 'Pending_Business_Detail_Checks.csv';
