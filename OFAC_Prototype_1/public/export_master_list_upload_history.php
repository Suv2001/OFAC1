...
$headers = ['Sl No.', 'Uploaded By', 'Uploaded At'];
...
switch ($type) {
    case 'pdf':
        ...
        class CustomPDF extends FPDF_Alpha
        {
            ...
            {   
                ...
                $this->Cell(0, 10, "Master List Upload History", 0, 1, 'C');
                $this->Ln(10);
            }
        }
        ...
        // Output the PDF
        $pdf->Output('D', 'Master_List_Upload_History.pdf');
        break;
    ...
    case 'excel':
        ...
        // Add title
        $sheet->setCellValue('A1', 'Master List Upload History');
        ...
        $sheet->setCellValue('C2', 'Export Date: ' . date('Y-m-d H:i:s'));
        ...
        $filename = 'Master_List_Upload_History.xlsx';
    ...
    case 'csv':
        ...
        $filename = 'Master_List_Upload_History.csv';
