...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM skipped_master_list WHERE 1=1";
    $params = [];
    $types = '';
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<tr><td colspan='8' class='text-center'>No Master List Input Skipped.</td></tr>";
    }
    ...
    <div class="sidebar">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu scrollable" style="display: block;">
                ...
                <a href="skipped_master_list.php" style="background-color:#4c51bf" class="dropdown-menu-items">Skipped Master List Items</a>
            </div>
        </div>
        ...
        <div class="table-container">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="d-flex align-items-center">
                    ...
                    <h1 class="ml-2"><b>Skipped Master List Item</b></h1>
                </div>
            </div>
            ...
            <form id="searchForm" method="post" class="search-filters">
                ...
                <div class="ddown">
                    ...
                    <div class="ddown-content">
                        <a href="export_skipped_master_list.php?type=pdf" onClick="empty();">PDF</a>
                        <a href="export_skipped_master_list.php?type=excel" onClick="empty();">Excel</a>
                        <a href="export_skipped_master_list.php?type=csv" onClick="empty();">CSV</a>
                    </div> -->
                </div>
            </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadTable() {
                ...
                $.ajax({
                    url: 'skipped_master_list.php', // Make sure to use the correct AJAX endpoint
                    method: 'POST',
                    data: formData,
