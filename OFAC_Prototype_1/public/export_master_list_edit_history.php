...
switch ($type) {
    case 'pdf':
        ...
        class CustomPDF extends FPDF_Alpha
        {
            ...
            function Header()
            {
                ...
                $this->Cell(0, 10, "Master List Edit History", 0, 1, 'C'); // Centered heading
        ...
        // Output the PDF
        $pdf->Output('D', 'Master_List_Edit_History.pdf');
        break;
    ...
    case 'excel':
        ...
        $sheet->setTitle('Master List Edit History');

        // Add title
        $sheet->setCellValue('A1', 'Master List Edit History');
        ...
        $filename = 'Master_List_Edit_History.xlsx';
    ...
    case 'csv':
        ...
        $filename = 'Master_List_Edit_History.csv';
