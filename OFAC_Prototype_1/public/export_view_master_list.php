...
// Fetch user's name using eid from session - with prepared statement for security
$eid = $_SESSION['eid'];
...
$headers = ['Sl No.', 'Business Name', 'Owner', 'Address', 'Reg. No.', 'Status', 'Uploaded By'];
...
switch ($type) {
    case 'pdf':
        ...
        class CustomPDF extends FPDF_Alpha
        {
            ...
            function Header()
            {
                ...
                $this->Cell(0, 10, "OFAC Master List", 0, 1, 'C'); // Centered heading
        ...
        // Output the PDF
        $pdf->Output('D', 'OFAC_Master_List.pdf');
        break;
    ...
    case 'excel':
        ...
        $sheet->setTitle('OFAC Master List');

        // Add title
        $sheet->setCellValue('A1', 'OFAC Master List');
        ...
        $filename = 'OFAC_Master_List.xlsx';
