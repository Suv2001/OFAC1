...
// Fetch user's name using eid from session - Using prepared statement for security
$eid = $_SESSION['eid'];
...
$headers = ['Sl No.', 'First Name', 'Last Name', 'Employee ID', 'Designation', 'Status', 'Added By', 'Added On'];
    ...
    case 'pdf':
        ...
        class CustomPDF extends FPDF_Alpha
        {
            ...
            {   
                ...
                $this->Cell(0, 10, "Employee List", 0, 1, 'C'); // Centered heading
